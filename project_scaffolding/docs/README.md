...
| [evidence/phase-0-exit-gates.md](./evidence/phase-0-exit-gates.md) | Phase 0 exit gate command output (refresh: `npm run record:phase0-evidence` from `project_scaffolding/`) |
...
The canonical **monorepo layout** is described in the MVP plan and root `README.md` (`apps/*`, `packages/*`, `database/` as schema pointer).
