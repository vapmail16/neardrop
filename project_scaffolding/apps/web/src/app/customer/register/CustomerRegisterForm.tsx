...
export function CustomerRegisterForm() {
  ...
  return (
    <main className="mx-auto flex max-w-md flex-col gap-6 p-8">
      <div>
        <h1 className="text-2xl font-semibold text-neutral-900">Create customer account</h1>
        <p className="mt-1 text-sm text-neutral-600">
          Use your UK postcode — we&apos;ll match a nearby pickup point when parcels arrive.
        </p>
        <p className="mt-1 text-sm text-neutral-600">
      ...
      <p className="text-sm text-neutral-600">
        ...
        <Link href="/login?portal=customer" className="font-medium text-neutral-900 underline">
          Sign in
        </Link>
      </p>
    </main>
