/**
 * Contract: `backend/.env.example` documents DATABASE_URL so local Postgres + migrate + E2E stay reproducible
...
const examplePath = path.join(apiPackageRoot, '.env.example');
